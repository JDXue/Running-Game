...
var context, controller, player, loop, rock;
var stageheight = 300;
var stagewidth = 540;
...
player = {
  ...
  //function for movement is now a method of the player class
  playerMove: function(){
...
rock = {
  ...
  //rock release function is now a method of the rock class
  rockDrop:function(){
    rock.x_velocity -= 0.5;
    rock.y_velocity += 0.5;
